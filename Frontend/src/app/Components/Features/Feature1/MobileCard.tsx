      ...
      >
        ...
        {colorScheme ? (
          ...
          <div className="mt-2 sm:mt-3 md:mt-4 text-center">
            ...
            <div className="mt-2 sm:mt-3 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
              <a
        ...
        <span className="attendance-effortless">{footerText}</span>
        {imageSrc ? (
          <div className="mt-2 sm:mt-3 md:mt-4 text-center">
            <div
              className="grainy-parallax-card inline-block "
              style={{
                borderRadius: "22px",
                padding: "10px",
                boxShadow:
