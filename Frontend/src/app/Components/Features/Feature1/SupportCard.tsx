...
const SupportCard: React.FC<SupportCardProps> = ({ colorScheme }) => {
  const defaultColors = {
  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: "15px", lineHeight: 1.6, color: "#333" }}>
        Access award-winning, 24/7 support and extensive training resources,
        from video courses to in-product help. Schedule one-on-one training or
        get assistance in your time zone from our global team.
      </p>
    </Card>
  );
};
